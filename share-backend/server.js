...
<body>
    <div class="container">
        <div class="logo">📇</div>
        <h1>Geteilte Kundenkarte</h1>
        <p>Öffne diese Karte in der Pocketz App, um sie zu speichern.</p>
        
        <button id="openApp" class="btn">Pocketz öffnen</button>
    ...
    <script>
        ...
        function tryOpenApp() {
            document.getElementById('status').innerHTML = '<div class="spinner"></div>Versuche App zu öffnen...';
